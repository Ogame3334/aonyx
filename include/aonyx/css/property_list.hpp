/** @brief Defines the property_list class and the make_property_list()
...
public:
     ...
     * @param prop The property to add or update (replaces any existing entry
     * with the same key).
     */
...
/** @brief std::formatter specialization for property_list, enabling use with
 * std::format. */
template <>
