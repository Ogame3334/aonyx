...
namespace property
{
struct font_feature_settings : types::property_base<"font-feature-settings">,
                               constants::global_values<font_feature_settings>
{
    ...
    font_feature_settings(std::string_view tag1,
