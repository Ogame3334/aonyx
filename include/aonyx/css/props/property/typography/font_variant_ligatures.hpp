...
namespace aonyx
{
    namespace css
    {
        namespace props
        {
            namespace property
            {
                struct font_variant_ligatures : types::property_base<"font-variant-ligatures">, constants::global_values<font_variant_ligatures>
                {
                    using super_property = types::property_base<"font-variant-ligatures">;

                    font_variant_ligatures() = delete;
                    font_variant_ligatures(std::string_view v) : super_property(std::string(v)) {}
