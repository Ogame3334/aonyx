...
struct font_family : types::property_base<"font-family">, constants::global_values<font_family>
{
    ...
    font_family(std::string_view family1, std::string_view family2)
        : super_property(std::format("{}, {}", family1, family2))
    {
    }
    font_family(std::string_view family1, std::string_view family2, std::string_view family3)
        : super_property(std::format("{}, {}, {}", family1, family2, family3))
    {
    }
