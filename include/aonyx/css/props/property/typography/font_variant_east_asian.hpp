...
namespace property
{
struct font_variant_east_asian : types::property_base<"font-variant-east-asian">,
                                 constants::global_values<font_variant_east_asian>
{
    using super_property = types::property_base<"font-variant-east-asian">;

    font_variant_east_asian() = delete;
    font_variant_east_asian(const std::string_view s) : super_property(std::string(s))
    {
    }
    font_variant_east_asian(std::string_view v1, std::string_view v2) : super_property(std::format("{} {}", v1, v2))
    {
    }
    font_variant_east_asian(std::string_view v1, std::string_view v2, std::string_view v3)
