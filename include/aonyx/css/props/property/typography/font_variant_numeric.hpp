...
namespace property
{
struct font_variant_numeric : types::property_base<"font-variant-numeric">,
                              constants::global_values<font_variant_numeric>
{
    ...
    font_variant_numeric(std::string_view v1, std::string_view v2, std::string_view v3)
        : super_property(std::format("{} {} {}", v1, v2, v3))
    {
    }
    font_variant_numeric(std::string_view v1, std::string_view v2, std::string_view v3, std::string_view v4)
