/** @brief CSS property: text-decoration
 *
...
struct text_decoration : types::property_base<"text-decoration">, constants::global_values<text_decoration>
{
    ...
    text_decoration(std::string_view line, std::string_view style, std::string_view color)
        : super_property(std::format("{} {} {}", line, style, color))
    {
    }
    text_decoration(std::string_view line, std::string_view style, std::string_view color, std::string_view thickness)
        : super_property(std::format("{} {} {} {}", line, style, color, thickness))
    {
    }
