...
namespace property
{
struct text_decoration_line : types::property_base<"text-decoration-line">,
                              constants::global_values<text_decoration_line>
{
    ...
    text_decoration_line(std::string_view v1, std::string_view v2, std::string_view v3)
