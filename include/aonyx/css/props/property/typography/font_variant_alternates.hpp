/** @brief CSS property: font-variant-alternates
 *
...
namespace property
{
struct font_variant_alternates : types::property_base<"font-variant-alternates">,
                                 constants::global_values<font_variant_alternates>
{
    using super_property = types::property_base<"font-variant-alternates">;

    font_variant_alternates() = delete;
    font_variant_alternates(const std::string_view s) : super_property(std::string(s))
    {
    }
