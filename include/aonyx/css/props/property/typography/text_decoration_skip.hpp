...
namespace property
{
struct text_decoration_skip : types::property_base<"text-decoration-skip">,
                              constants::global_values<text_decoration_skip>
{
    ...
    text_decoration_skip(std::string_view v1, std::string_view v2, std::string_view v3)
        : super_property(std::format("{} {} {}", v1, v2, v3))
    {
    }
    text_decoration_skip(std::string_view v1, std::string_view v2, std::string_view v3, std::string_view v4)
        : super_property(std::format("{} {} {} {}", v1, v2, v3, v4))
    {
    }
    text_decoration_skip(
        std::string_view v1, std::string_view v2, std::string_view v3, std::string_view v4, std::string_view v5)
        : super_property(std::format("{} {} {} {} {}", v1, v2, v3, v4, v5))
    {
    }
    text_decoration_skip(std::string_view v1,
                         std::string_view v2,
                         std::string_view v3,
                         std::string_view v4,
                         std::string_view v5,
                         std::string_view v6)
        : super_property(std::format("{} {} {} {} {} {}", v1, v2, v3, v4, v5, v6))
    {
    }
