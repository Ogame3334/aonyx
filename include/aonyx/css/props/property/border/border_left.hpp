...
struct border_left : types::property_base<"border-left">, constants::global_values<border_left>
{
    ...
    border_left() = delete;
    border_left(const std::string_view s) : super_property(std::string(s))
    {
    }
    ...
    border_left(std::string_view width, std::string_view style, std::string_view color)
        : super_property(std::format("{} {} {}", width, style, color))
    {
    }
    border_left(util::numerical width, std::string_view style, std::string_view color)
        : super_property(std::format("{} {} {}", width, style, color))
    {
    }
};
