...
struct border_width : types::property_base<"border-width">, constants::global_values<border_width>
{
    ...
    border_width(util::numerical vertical, util::numerical horizontal)
        : super_property(std::format("{} {}", vertical, horizontal))
    {
    }
    border_width(util::numerical top, util::numerical horizontal, util::numerical bottom)
        : super_property(std::format("{} {} {}", top, horizontal, bottom))
    {
    }
    border_width(util::numerical top, util::numerical right, util::numerical bottom, util::numerical left)
