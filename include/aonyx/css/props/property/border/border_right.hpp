...
namespace property
{
struct border_right : types::property_base<"border-right">, constants::global_values<border_right>
{
    ...
    border_right(std::string_view width, std::string_view style, std::string_view color)
        : super_property(std::format("{} {} {}", width, style, color))
    {
    }
    border_right(util::numerical width, std::string_view style, std::string_view color)
        : super_property(std::format("{} {} {}", width, style, color))
    {
    }
};
