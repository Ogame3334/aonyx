...
namespace property
{
struct border_inline_end_width : types::property_base<"border-inline-end-width">,
                                 constants::global_values<border_inline_end_width>
{
    using super_property = types::property_base<"border-inline-end-width">;

    border_inline_end_width() = delete;
    border_inline_end_width(const std::string_view s) : super_property(std::string(s))
    {
    }
