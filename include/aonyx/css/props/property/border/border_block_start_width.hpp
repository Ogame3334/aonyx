/** @brief CSS property: border-block-start-width
 *
...
namespace property
{
struct border_block_start_width : types::property_base<"border-block-start-width">,
                                  constants::global_values<border_block_start_width>
{
