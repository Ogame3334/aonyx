        ...
        namespace props
        {
            namespace property
            {
                struct border_block_end : types::property_base<"border-block-end">, constants::global_values<border_block_end>
                {
                    ...
                    border_block_end(std::string_view style, std::string_view color) : super_property(std::format("{} {}", style, color)) {}
                    border_block_end(util::numerical width, std::string_view style, std::string_view color) : super_property(std::format("{} {} {}", width, style, color)) {}
                };
            }
        }
    }
