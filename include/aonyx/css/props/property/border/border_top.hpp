...
struct border_top : types::property_base<"border-top">, constants::global_values<border_top>
{
    ...
    border_top(std::string_view width, std::string_view style, std::string_view color)
        : super_property(std::format("{} {} {}", width, style, color))
    {
    }
    border_top(util::numerical width, std::string_view style, std::string_view color)
        : super_property(std::format("{} {} {}", width, style, color))
    {
    }
};
