/** @brief CSS property: border-inline-start
 *
...
struct border_inline_start : types::property_base<"border-inline-start">, constants::global_values<border_inline_start>
{
    ...
    border_inline_start(std::string_view style, std::string_view color)
        : super_property(std::format("{} {}", style, color))
    {
    }
    border_inline_start(util::numerical width, std::string_view style, std::string_view color)
