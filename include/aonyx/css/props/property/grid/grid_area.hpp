...
struct grid_area : types::property_base<"grid-area">, constants::global_values<grid_area>
{
    ...
    grid_area() = delete;
    grid_area(std::string_view row_start,
              std::string_view column_start,
              std::string_view row_end,
              std::string_view column_end)
        : super_property(std::format("{} / {} / {} / {}", row_start, column_start, row_end, column_end))
    {
    }
    grid_area(std::string_view row_start, std::string_view column_start)
