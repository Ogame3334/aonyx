/** @brief CSS property: grid-template-columns
 *
...
namespace property
{
struct grid_template_columns : types::property_base<"grid-template-columns">,
                               constants::global_values<grid_template_columns>
{
    ...
    grid_template_columns(std::string_view v1, std::string_view v2, std::string_view v3)
        : super_property(std::format("{} {} {}", v1, v2, v3))
    {
    }
    grid_template_columns(std::string_view v1, std::string_view v2, std::string_view v3, std::string_view v4)
