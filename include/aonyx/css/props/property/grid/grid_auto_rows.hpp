        ...
        namespace props
        {
            namespace property
            {
                struct grid_auto_rows : types::property_base<"grid-auto-rows">, constants::global_values<grid_auto_rows>
                {
                    ...
                    grid_auto_rows(std::string_view v) : super_property(std::string(v)) {}
                    grid_auto_rows(std::string_view v1, std::string_view v2) : super_property(std::format("{} {}", v1, v2)) {}
                    grid_auto_rows(std::string_view v1, std::string_view v2, std::string_view v3) : super_property(std::format("{} {} {}", v1, v2, v3)) {}
                };
            }
        }
    }
