/** @brief CSS property: mask-border-slice
 *
...
struct mask_border_slice : types::property_base<"mask-border-slice">, constants::global_values<mask_border_slice>
{
    ...
    mask_border_slice(const std::string_view s) : super_property(std::string(s))
    {
    }
    mask_border_slice(std::string_view v1, std::string_view v2) : super_property(std::format("{} {}", v1, v2))
    {
    }
    mask_border_slice(std::string_view v1, std::string_view v2, std::string_view v3)
        : super_property(std::format("{} {} {}", v1, v2, v3))
    {
    }
    mask_border_slice(std::string_view v1, std::string_view v2, std::string_view v3, std::string_view v4)
        : super_property(std::format("{} {} {} {}", v1, v2, v3, v4))
    {
    }
    mask_border_slice(
        std::string_view v1, std::string_view v2, std::string_view v3, std::string_view v4, std::string_view fill)
        : super_property(std::format("{} {} {} {} {}", v1, v2, v3, v4, fill))
    {
    }
