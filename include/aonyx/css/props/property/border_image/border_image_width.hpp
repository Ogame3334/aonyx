/** @brief CSS property: border-image-width
 *
...
struct border_image_width : types::property_base<"border-image-width">, constants::global_values<border_image_width>
{
    ...
    border_image_width(std::string_view top, std::string_view left_right, std::string_view bottom)
        : super_property(std::format("{} {} {}", top, left_right, bottom))
    {
    }
    border_image_width(std::string_view top, std::string_view right, std::string_view bottom, std::string_view left)
