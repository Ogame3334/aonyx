...
struct border_radius : types::property_base<"border-radius">, constants::global_values<border_radius>
{
    ...
    border_radius(util::numerical tl, util::numerical tr_bl, util::numerical br)
        : super_property(std::format("{} {} {}", tl, tr_bl, br))
    {
    }
    border_radius(util::numerical tl, util::numerical tr, util::numerical br, util::numerical bl)
        : super_property(std::format("{} {} {} {}", tl, tr, br, bl))
    {
    }
};
} // namespace property
