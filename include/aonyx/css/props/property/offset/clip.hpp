        ...
        namespace props
        {
            namespace property
            {
                struct clip : types::property_base<"clip">, constants::global_values<clip>
                {
                    ...
                    clip(std::string_view v1, std::string_view v2, std::string_view v3) : super_property(std::format("{} {} {}", v1, v2, v3)) {}
                    clip(std::string_view v1, std::string_view v2, std::string_view v3, std::string_view v4) : super_property(std::format("{} {} {} {}", v1, v2, v3, v4)) {}
