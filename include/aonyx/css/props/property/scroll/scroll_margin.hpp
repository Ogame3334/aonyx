        ...
        namespace props
        {
            namespace property
            {
                struct scroll_margin : types::property_base<"scroll-margin">, constants::global_values<scroll_margin>
                {
                    ...
                    scroll_margin(std::string_view v1, std::string_view v2, std::string_view v3) : super_property(std::format("{} {} {}", v1, v2, v3)) {}
                    scroll_margin(std::string_view v1, std::string_view v2, std::string_view v3, std::string_view v4) : super_property(std::format("{} {} {} {}", v1, v2, v3, v4)) {}
                };
            }
        }
    }
