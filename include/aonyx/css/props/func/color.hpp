    ...
    namespace css
    {
        namespace props
        {
            namespace func
            {
                ...
                std::string color(std::string_view colorspace, util::numerical c1, util::numerical c2, util::numerical c3, util::numerical alpha)
                {
                ...
                std::string color_mix(std::string_view method, std::string_view color1, std::string_view color2, std::string_view color3)
                {
                ...
                std::string dynamic_range_limit_mix(std::string_view limit1, std::string_view percent1, std::string_view limit2, std::string_view percent2)
                {
